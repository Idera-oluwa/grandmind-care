...
const hero = () => {
  return (
    ...
    >
          ...
          <Fade><div className="flex flex-row gap-[8px] items-center cursor-pointer">
          <img
      ...
      <p className="text-[14px] font-normal text-center text-[#1B1B1E] mt-[1rem] w-[95%] md:w-[669px]">
        Welcome to Grandmind Care, our journey is fueled by a deep commitment to
        enhancing lives through compassionate care{" "}
      </p>
      <Link href="#register">
        {" "}
