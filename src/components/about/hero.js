  ...
  return (
    <div className='flex flex-col items-center'>
      <div className='flex flex-row gap-[20px]'>
       ...
       <button className='bg-[#474973] rounded-[22px] py-[12px] px-[20px] text-[15px] font-bold text-[#FDFDFD] tracking-[1px] mt-[1rem] border border-transparent hover:border-[#1B1B1E] hover:text-black hover:bg-transparent transition ease-in-out delay-300'>Register today</button>
    </div>
  )
}
