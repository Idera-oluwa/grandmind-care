...
const joinus = () => {
  ...
  return (
    <div className='mt-[10rem] px-[3rem]' id='register'>
        ...
        <div className='w-full md:w-[50%]'>
         <div className='w-full md:w-[90%] bg-[#47497310] ml-auto p-[3rem] rounded-[10px] border border-[#47497328]'>
           <form>
            ...
            <input type="text" value={name} onChange={(e) => setName(e.target.value)} name='first-name' placeholder='First Name' className='py-[15px] px-[20px] border border-[#47497380] w-full text-[14px] font-bold text-[#474973] rounded-[10px] outline-none bg-[#47497303] h-[52px]'/>
            <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} name='email' placeholder='Email Address' className='py-[15px] px-[20px] border border-[#47497380] w-full text-[14px] font-bold text-[#474973] rounded-[10px] outline-none bg-[#47497303] h-[52px] '/>
