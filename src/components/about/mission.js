...
const mission = () => {
  return (
    <div className='mt-[6rem] relative w-full h-[20rem] md:h-auto'>
      ...
      <div className='absolute w-full h-full top-0 flex flex-col items-center justify-center'>
        <h1 className='font-bold text-[35px] md:text-[40px] text-white'>Our Mission</h1>
        <p className='text-[16px] md:text-[20px] font-medium text-white w-[95%] md:w-[865px] text-center'>Welcome to Grandmind Care, our journey is fueled by a deep commitment to enhancing lives through compassionate care </p>
