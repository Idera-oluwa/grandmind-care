  ...
  return (
    <div className='mt-[7rem] md:mt-[10rem] relative w-full h-[20rem] md:h-auto'>
      ...
      <div className='absolute w-full h-full top-0 flex flex-col items-center justify-center'>
        ...
        <p className='text-[14px] md:text-[16px] font-medium text-white w-[95%] md:w-[865px] text-center'>Welcome to Grandmind Care, our journey is fueled by a deep commitment to enhancing lives through compassionate care </p>
