...
const team = () => {
  return (
    <div className='mt-[5rem]'>
      ...
      <p className='text-center w-[95%] lg:w-[833px] font-normal text-[16px] mt-[1rem] mx-auto'>Get to know the faces and stories of the individuals working tirelessly to make our platform a trusted and compassionate space.</p>
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-[3rem] justify-between px-[5rem] gap-[2rem] md:gap-[1rem]'>
        <div>
