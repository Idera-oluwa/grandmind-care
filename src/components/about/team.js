...
const team = () => {
  return (
    <div className='mt-[10rem]'>
      ...
      <Fade><div>
            <img src='/Images/about/president4.png' alt='' className='mx-auto w-[253px] h-[256px]'/>
        ...
        <div>
            <img src='/Images/about/Praise.png' alt='' className='mx-auto w-[253px] h-[256px]'/>
        ...
        <div>
            <img src='/Images/about/Mitchell.png' alt='' className='mx-auto w-[253px] h-[256px]'/>
