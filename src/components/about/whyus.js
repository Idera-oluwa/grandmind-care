  ...
  return (
    <div className='mt-[6rem] md:mt-[8rem]'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-[2rem] gap-[2rem] md:gap-[2rem] md:px-[3rem]'>
       <div className='bg-[#32936F] flex flex-col items-center justify-center h-[273px] rounded-[10px] px-[2rem] md:px-[3rem] cursor-pointer hover:translate-y-[-0.5rem] transition ease-in duration-300 '>
