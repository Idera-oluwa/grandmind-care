...
const whyus = () => {
  return (
    <div className='mt-[6rem]'>
      <h1 className='text-[24px] font-semibold text-[#1B1B1E] text-center'>What Sets Us Apart?</h1>
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-[2rem] gap-[2rem] md:gap-[1rem]'>
