...
const contact = () => {
  return (
    <div className='mt-[10rem] relative pb-[5rem] h-[652px]'>
      ...
      <div className='py-[1rem] md:py-[1rem] text-center flex flex-col items-center w-full'>
        ...
        <p className='text-[12px] font-medium text-white w-[95%] md:w-[80%] lg:w-[40%] text-center mt-[8px]'>Contacting the team is easy, enter your name, your email, and your message to get started.</p>
      </div>
  ...
  method="POST">
            ...
            <button type="submit" className='bg-[#474973] rounded-[10px] font-semibold text-[20px] w-full mt-[3rem] h-[64px] text-white hover:border-transparent hover:bg-[#353756] transition ease-in-out delay-500'>Submit</button>
         </form>
       </div>
      </div>
      </div>
