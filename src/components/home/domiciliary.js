     ...
     <div className='mt-[2rem] relative h-[290px] md:h-[412px] w-[100%]'>
      ...
      className='h-full'>
        ...
        <div className='flex flex-col md:flex-row w-full h-full items-center px-[1rem] md:px-[3rem] justify-center'>
          <img src='/Images/home/domiciliary-img.png' alt='' className='h-[128px] lg:h-[329px] w-[100%] md:w-[50%] md:grid rounded-[5px] object-contain'/>
        ...
        <SwiperSlide>
        <div className='flex flex-col md:flex-row w-full h-full items-center px-[1rem] md:px-[3rem] justify-center'>
          <img src='/Images/home/hero3.png' alt='' className='h-[128px] lg:h-[329px] w-[100%] md:w-[50%] md:grid rounded-[5px] object-contain'/>
          <div className='flex flex-col ml-0 md:ml-[3rem] w-[100%] md:w-[50%] mt-[1rem] md:mt-0'>
        ...
        <SwiperSlide>
        <div className='flex flex-col md:flex-row w-full h-full items-center px-[1rem] md:px-[3rem] justify-center'>
          <img src='/Images/home/domiciliary2.png' alt='' className='h-[128px] lg:h-[329px] w-[100%] md:w-[50%] md:grid rounded-[5px] object-contain'/>
          <div className='flex flex-col ml-0 md:ml-[3rem] w-[100%] md:w-[50%] mt-[1rem] md:mt-0'>
