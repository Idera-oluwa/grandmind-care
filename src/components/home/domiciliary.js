...
const domiciliary = () => {
  ...
  return (
    <div className='mt-[10rem]'>
     ...
     <div className='mt-[2rem] relative h-[246px] md:h-[412px] w-[100%]'>
      ...
      className='h-full'>
        ...
        <div className='flex flex-col md:flex-row w-full h-full items-center px-[1rem] md:px-[3rem] justify-center'>
          ...
          <div className='flex flex-col ml-0 md:ml-[3rem] w-[100%] md:w-[50%] '>
           <p className='font-medium text-[20px] md:text-[40px] text-[#FFFFFF]'>Trusted Professionals</p>
           <p className='font-normal text-[14px] text-[#FFFFFF]'>is to make this journey smoother for both caregivers and those in need of care.</p>
        ...
        <div className='flex flex-col md:flex-row w-full h-full items-center px-[1rem] md:px-[3rem] justify-center'>
          ...
          <div className='flex flex-col ml-0 md:ml-[3rem] w-[100%] md:w-[50%] '>
           <p className='font-medium text-[20px] md:text-[40px] text-[#FFFFFF]'>Dependable <span className='text-[#32936F]'>&</span> Reliable</p>
           <p className='font-normal text-[14px] text-[#FFFFFF]'>is to make this journey smoother for both caregivers and those in need of care.</p>
           <Link href='/about'><button className='bg-[#474973] py-[5px] flex items-center justify-center rounded-[32px] text-[15px] font-medium text-[#F6F8FF] w-[122px] mt-[2rem]'>Learn more</button></Link>
          </div>
        </div>
        ...
        <div className='flex flex-col md:flex-row w-full h-full items-center px-[1rem] md:px-[3rem] justify-center'>
          ...
          <div className='flex flex-col ml-0 md:ml-[3rem] w-[100%] md:w-[50%] '>
           <p className='font-medium text-[20px] md:text-[40px] text-[#FFFFFF]'>Personalised <span className='text-[#32936F]'>Care</span></p>
           <p className='font-normal text-[14px] text-[#FFFFFF]'>is to make this journey smoother for both caregivers and those in need of care.</p>
           <Link href='/about'><button className='bg-[#474973] py-[5px] flex items-center justify-center rounded-[32px] text-[15px] font-medium text-[#F6F8FF] w-[122px] mt-[2rem]'>Learn more</button></Link>
          </div>
        </div>
