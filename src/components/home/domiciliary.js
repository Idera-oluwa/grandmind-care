     ...
     <div className='mt-[2rem] relative h-[250px] md:h-[412px] w-[100%]'>
      ...
      className='h-full'>
        ...
        <div className='flex flex-col md:flex-row w-full h-full items-center px-[1rem] md:px-[3rem] justify-center'>
          ...
          <div className='flex flex-col ml-0 md:ml-[3rem] w-[100%] md:w-[50%] mt-[0.5rem] md:mt-0'>
           <p className='font-bold text-[14px] md:text-[40px] text-[#E27396] text-center md:text-left'>Tailor <span className='text-[#FFFFFF] font-medium'>Made Services</span></p>
        ...
        <div className='flex flex-col md:flex-row w-full h-full items-center px-[1rem] md:px-[3rem] justify-center'>
          ...
          <div className='flex flex-col ml-0 md:ml-[3rem] w-[100%] md:w-[50%] mt-[0.5rem] md:mt-0'>
           <p className='font-medium text-[14px] md:text-[40px] text-[#FFFFFF] text-center md:text-left'> <span className='text-[#32936F] font-bold'>Be-Spoke</span> Care Services</p>
