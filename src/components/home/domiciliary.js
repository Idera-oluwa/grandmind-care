      ...
      className='h-full'>
        ...
        <div className='flex flex-col md:flex-row w-full h-full items-center px-[1rem] md:px-[3rem] justify-center'>
          ...
          <div className='flex flex-col ml-0 md:ml-[3rem] w-[100%] md:w-[50%] mt-[1rem] md:mt-0'>
           <p className='font-medium text-[20px] md:text-[40px] text-[#E27396] text-center md:text-left'>Tailor <span className='text-[#FFFFFF]'>Made Services</span></p>
           <p className='font-normal text-[14px] text-[#FFFFFF] text-center md:text-left'>Personalized care plans, ensuring that each person receives the specific support required for their well-being.</p>
        ...
        <div className='flex flex-col md:flex-row w-full h-full items-center px-[1rem] md:px-[3rem] justify-center'>
          ...
          <div className='flex flex-col ml-0 md:ml-[3rem] w-[100%] md:w-[50%] mt-[1rem] md:mt-0'>
           <p className='font-medium text-[20px] md:text-[40px] text-[#FFFFFF] text-center md:text-left'> <span className='text-[#32936F]'>Be-Spoke</span> Care Services</p>
           <p className='font-normal text-[14px] text-[#FFFFFF] text-center md:text-left'>We create bespoke care plans that address your specific requirements</p>
           <Link href='/about'><button className='bg-[#474973] py-[5px] flex items-center justify-center rounded-[32px] text-[15px] font-medium text-[#F6F8FF] w-[122px] mt-[1rem] md:mt-[2rem] mx-auto md:ml-0'>Learn more</button></Link>
          </div>
        </div>
        </SwiperSlide>
