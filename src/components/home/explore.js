  ...
  return (
    <div className='flex flex-row mt-[5rem] items-center'>
      <div className='w-[50%]'>
       ...
       <button className='py-[5px] px-[20px] border border-[#1B1B1E] text-[#1B1B1E] rounded-[32px] mt-[1rem] hover:bg-[#474973] hover:border-transparent hover:text-[#FDFDFD] transition ease-in-out delay-300'>Learn more</button>
      </div>
