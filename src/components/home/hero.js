     ...
     <div className='w-full md:w-[47%]'>
       ...
       <div className='flex flex-row gap-[8px] items-center cursor-pointer'>
         <Image src='/Images/home/mail-sm.png'
          ...
          height={16}
           />
         <a href="mailto:info@grandmind.co.uk"><p className='text-[13px] md:text-[14px] font-normal text-[#474973]'>info@grandmind.co.uk</p></a>
       </div>
       <div className='flex flex-row gap-[8px] items-center cursor-pointer'>
         <img src='Images/home/whatsapp-icon.png' alt='' className='w-[17px] h-[17px]'/>
         <a href='https://wa.me/447903220307' target="_blank" rel="noreferrer"><p className='text-[13px] md:text-[14px] font-normal text-[#474973]'>07903220307</p></a>
       </div>
       </div>
       ...
       <p className='text-[14px] md:text-[14px] leading-[25.6px] text-[#1B1B1E] font-normal w-[95%] md:w-[80%] mt-[0.5rem] md:mt-[2rem]'>We're delighted to welcome you to <span className='text-[#474973] font-semibold'>Grandmind Care LTD</span>, where compassionate care meets cutting-edge convenience. Here, you’ll find a supportive community,valuable resources, and a seamless interaction with our professional carers.</p>
