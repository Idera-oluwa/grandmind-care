    ...
    <div className='mt-[4rem]'>
      ...
      <div className='mt-[2rem]'>
        ...
        <div className='col-span-1 px-[1rem]'>
         ...
         <button className='py-[5px] px-[20px] border border-[#1B1B1E] text-[#1B1B1E] rounded-[32px] hover:bg-[#474973] hover:border-transparent hover:text-[#FDFDFD] transition ease-in-out delay-300'>Learn more</button>
