    ...
    <div className='mt-[6rem] w-full lg:w-[90%] mx-auto flex flex-col gap-[4rem]'>
      <div className='flex flex-col md:flex-row items-center gap-[2rem] md:gap-0'>
        <div className='w-full md:w-[50%]'>
            ...
            <p className='text-[16px] font-normal w-full lg:w-[90%] mt-[1rem]'>We offer respite care services to provide temporary relief for family caregivers. This allows you to take a break while ensuring your loved ones receive the care they need.</p>
        </div>
