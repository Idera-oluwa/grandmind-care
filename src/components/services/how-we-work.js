...
const howWeWork = () => {
  return (
    <div className='mt-[12rem] bg-[#252648] w-full lg:w-[90%] mx-auto flex flex-col-reverse lg:flex-row relative h-auto lg:h-[312px] py-[2rem] lg:py-0 rounded-[10px] lg:px-[3rem]'>
       ...
       <div className='w-full lg:w-[40%] ml-auto mr-[3rem] flex flex-col items-center'>
        ...
        <img src='Images/services/care5.png' alt='' className='mt-[1rem] w-[95%] lg:w-auto mx-auto object-cover'/>
       </div>
    </div>
  )
}
