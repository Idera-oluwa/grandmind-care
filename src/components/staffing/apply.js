    ...
    <div className='md:bg-[#2A2C58] w-full py-[3rem] mt-[7rem] md:mt-[10rem] relative mb-[7rem] md:mb-[12rem]' id="apply">
      <div className='w-[90vw] lg:w-[80vw]  2xl:max-w-[1440px] mx-auto md:flex md:flex-row items-center justify-between'>
        <div className='md:w-[50%]'>
            <p className='text-[24px] text-[#1B1B1E] md:text-[32px] md:text-[#FFFFFF] font-semibold leading-[48.41px] text-center md:text-left'>Ready to join us?</p>
            <p className='text-[12px] md:text-[14px] text-[#1B1B1E] md:text-[#FFFFFF] font-normal leading-[16.9px] md:mt-[1rem] text-center md:text-left w-[90%] mx-auto md:w-full'>Click the button below to get started with your application to join us in any of the positions.</p>
