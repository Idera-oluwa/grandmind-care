    ...
    <div className='mt-[7rem] md:mt-[12rem] max-w-[100vw] mb-[22rem]'>
      ...
      <div className='w-full bg-[#474973] h-[336px] flex flex-col lg:flex-row  px-[4rem]'>
       <div className='w-full lg:w-[30%] my-[auto]'>
        <h1 className='font-semibold md:text-[40px] text-[30px] text-[white]'>Tell us about you!</h1>
        <p className='font-semibold md:text-[16px] text-[14px] text-[white] mt-[1rem]'>Get started with your application here, send a detailed copy of your cv to us and let us review your application.</p>
       </div>
       ...
       <div className="w-full h-[528px] p-[1rem] rounded-[10px] bg-[#474973] items-center justify-center">
          <div className="w-full h-full border border-[#424359] rounded-[20px] bg-white p-[2rem]">
            <form>
              ...
              <label className='text-[14px] font-medium text-[#171C74] mt-[1rem] cursor-pointer'> Click to upload your CV
                <input
          type="file"
          className="hidden"
