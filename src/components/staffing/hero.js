...
<div className='flex flex-row mt-[5rem] items-center'>
      <div className='w-[50%]'>
       ...
       <button className='bg-[#474973] rounded-[22px] py-[12px] px-[20px] text-[15px] font-bold text-[#FDFDFD] tracking-[1px] mt-[2rem] hover:text-black border border-transparent hover:border-[#1B1B1E] hover:bg-transparent transition ease-in-out delay-300'>Register today</button>
      </div>
