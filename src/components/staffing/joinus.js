...
const joinus = () => {
  return (
    <div className='mt-[6rem] grid grid-cols-1 lg:grid-cols-2 h-auto'>
      <div className='col-span-1 bg-[#2A2C58] h-full px-[1rem] md:px-[2rem] flex flex-col justify-center pb-[2rem] lg:pb-[2rem] rounded-t-[10px] lg:rounded-tl-[10px] lg:rounded-bl-[10px] lg:rounded-t-[0px] pt-[1rem] lg:pt-[3rem]'>
