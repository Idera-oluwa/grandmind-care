...
const whyus = () => {
  return (
    <div className='mt-[6rem] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[1rem]'>
      <div className='h-auto shadow-shadow3 px-[1rem] py-[2rem] flex flex-col items-center col-span-1'>
