      ...
      <div className='w-[80%] bg-[#F4EEEE] px-[4rem] py-[2rem] mx-auto'>
        <div className='flex flex-row justify-between items-center border-b border-[#76778399] pb-[3rem]'>
            ...
            <div className='flex flex-row'>
               <input type='text' name='subscribe' placeholder='Enter your email' className='font-medium text-[14px] text-[#767783] w-[306px] px-[1rem] h-[59px]'/>
               <div className='bg-[#FFD166] w-[62px] h-[59px] rounded-[5px] flex justify-center items-center cursor-pointer'><img src='Images/subscribe-arrow.png' alt=''/></div>
            </div>
        </div>
        <div className='flex flex-row mt-[3rem] justify-between border-b border-[#76778399] pb-[3rem]'>
          {/* Left hand side */}
          <div className='w-[50%]'>
            <img src='Images/LOGO.png' alt='' className='w-[164px] h-[41.65px]'/>
